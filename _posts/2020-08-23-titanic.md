...
date: 2020-08-23
tags: [supervised learning, kaggle, titanic, randomforestclassifier, lda]
header:
...
```
    ...
    array([<matplotlib.axes._subplots.AxesSubplot object at 0x000001E6DE7A3AC8>,
           <matplotlib.axes._subplots.AxesSubplot object at 0x000001E6DE7DD388>],
          dtype=object)
...
```
    ...
    array([<matplotlib.axes._subplots.AxesSubplot object at 0x000001E6DE91C0C8>,
           <matplotlib.axes._subplots.AxesSubplot object at 0x000001E6DE98DD88>],
          dtype=object)
...
```
    ...
    <seaborn.axisgrid.FacetGrid at 0x1e6de9dbd08>
...
```
    ...
    <seaborn.axisgrid.FacetGrid at 0x1e6de6cfb88>
...
```
    ...
    <seaborn.axisgrid.FacetGrid at 0x1e6deae3948>
...
```
    ...
    <seaborn.axisgrid.FacetGrid at 0x1e6dea61188>
...
```
    ...
    <seaborn.axisgrid.FacetGrid at 0x1e6deb9d308>
...
We see that the optimal value of min_samples_split is 10, and the optimal value of max_features is 6. Now, we refit the Random Forest of Classification Trees with the optimal values of the hyperparameters.


```python
# Refit the Random Forest Classifier with optimal hyperparameters
rf_model = RandomForestClassifier(n_estimators=1000, max_features = 6, min_samples_split=10, random_state=0)
rf_model.fit(X_train, y_train)
...
```
    ...
    RandomForestClassifier(max_features=6, min_samples_split=10, n_estimators=1000,
                           random_state=0)
